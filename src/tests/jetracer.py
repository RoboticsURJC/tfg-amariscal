...
class MyRacecar():
    ...
    def _on_steering(self, steering):
        if round(steering, 1) > 0.5:
            ...
            print("Right: Original Steering:" + str(steering) +
                  " result: " + str(right_speed) + " Throttle: " + str(23))
            ...
            print("Left: Original Steering:" + str(steering) +
                  " result: " + str(left_speed) + " Throttle: " + str(23))
        else:
            self._go_forward()
            self._set_speed(self.throttle_motor, self.throttle_motor)
            print("Forward: " + str(steering) +
                  " Throttle: " + str(self.throttle_motor))
