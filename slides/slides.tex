...
\begin{frame}[plain]
	...
	\note[item]{Voy a presentar mi trabajo fin de grado titulado: Conducción autónoma sobre plataforma real y simulada con seguimiento de carril e identificación de señales de
		tráfico y
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics[width=8cm]{figs/AI}
	\end{figure}
...
\begin{frame}
	...
	\end{figure}
	\begin{outline}
		\1 \textcolor{red}{Neocognitrón} (1979): NN 5/6 capas \textcolor{red}{caracteres japoneses}.
	\end{outline}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics[width=6cm]{figs/volvovera}
	...
	\note[item]{Existen diferentes niveles de autonomía. En el caso de la fotografía es un camión autónomo de la marca Volvo con nivel de autonomía 5, es decir, automatización
		completa en cualquier situación. Se han desarrollado pruebas en el puerto de Gotemburgo}
...
\begin{frame}
	...
	\begin{itemize}
		\item \textit{GNU/Linux}: \textcolor{red}{\textit{Ubuntu 18.04 LTS}}.
		\item Entorno simulado tarjeta gráfica dedicada: \textcolor{red}{\textit{NVIDIA}} y \textcolor{red}{\textit{CUDA}}.
		\item Entorno real \textcolor{red}{\textit{NVIDIA Jetson Nano}}, económica con \textcolor{red}{\textit{GPU}}.
		\item Lenguaje de programación \textcolor{red}{\textit{Python}}.
	\end{itemize}
...
\begin{frame}
	...
	\end{figure}
	\begin{outline}
		\1 Red \textcolor{red}{\textit{ResNet-18}}: convolucional de \textcolor{red}{18} capas con \textcolor{red}{bloques residuales}.
	...
	\end{outline}
	\note[item]{En cuanto al seguimiento de carril se utiliza un red ResNet-18 preentrenada que es una red convolucional de 18 capas con bloques residuales que permiten
		incrementar el número de capas sin perder rendimiento ni precisión.}
...
\begin{frame}
	...
	\note[item]{Batch: número de ejemplos que se introducen en la red para que entrene de cada vez. Mayor más precisión más tiempo.}
\end{frame}
...
\begin{frame}
	...
	\note[item]{Alrededor de 2 metros de largo.}
\end{frame}
...
\begin{frame}
	...
	\end{figure}
	\note[item]{Entrenamiento red de detección de objetos.}
	\note[item]{Se muestra el \textit{mAP} (\textit{mean Average Precision}), valor que alcanza el 98\%. Esto es una métrica de precisión que se calcula cada 4 \textit{epochs}
		(a partir de 1000 iteraciones) usando el \textit{dataset} de validación. Una \textit{epoch} es un número de iteraciones atendiendo a la siguiente fórmula:
		\textit{número\_imágenes\_entrenamiento / batch}. En el caso de que este valor (expresado en porcentaje en la gráfica) se decrementara y el \textit{loss} siguiese
		bajando, la red
		se estaría sobreajustando. Es lo que se conoce como \textit{overfitting}.}
\end{frame}
...
\begin{frame}[plain]
	\large{\titlepage}
	\note[item]{Vídeo.}
	\note[item]{Con las conclusiones doy por terminada mi presentación y quedo a su disposición.}
\end{frame}
