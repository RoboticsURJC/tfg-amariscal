...
\begin{figure} [h!]
	\begin{center}
		\includegraphics[width=0.9\textwidth]{figs/raspberrypi}\hspace{0.5cm}\includegraphics[width=0.9\textwidth]{figs/jetsonnano}
...
\begin{figure} [h!]
	\begin{center}
		\includegraphics[width=0.9\textwidth]{figs/lattepanda}\hspace{0.5cm}\includegraphics[width=0.9\textwidth]{figs/teslazenrdna2}
		\caption{Equipos  \textit{x86\_64}: \textit{LattePanda Alpha 864s} y \textit{AMD Zen} como CPU y \textit{Navi 23} como GPU, usado en Tesla Model S \cite{teslazenrdna2}.}
	\end{center}
	\label{fig:x86}
\end{figure}\
