...
% Resnet
% NN siempre yxy?
% yolov3-tiny.conv.15 15 convolución 15 preentrenada por qué? y con qué dataset?
% \textit{Over-fitting}, current avg loss incluye el error del set de entrenamiento y el de validación?
% Salir de sección screenshotsreal
% 7 epochs 
% Controller problems and function
% Small city text
