...
\begin{figure} [h!]
	\begin{center}
		\includegraphics[width=2cm, height=5cm]{figs/trafficlightreal}\hspace{0.1cm}\includegraphics[width=4cm,
			height=5cm]{figs/stopsign}\hspace{0.1cm}\includegraphics[width=4cm, height=5cm]{figs/pedestrian}
	\end{center}
